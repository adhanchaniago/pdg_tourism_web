        ...
        function kecamatanMobileTampil() // PENAMPILAN PEMBAGIAN KECAMATAN DI PADANG MOBILE
        {   
        ...
        function kecamatanTampil() // PENAMPILAN PEMBAGIAN KECAMATAN DI PADANG WEB
        {   
          kecamatan = new google.maps.Data();
          kecamatan.loadGeoJson(server+'kecamatan.php');
          kecamatan.setStyle(function(feature)
        ...
        {
          $('#tombol').empty();
          $('#tombol').append('<a type="button" id="hidelegenda" onclick="hideLegenda()" class="btn btn-default" data-toggle="tooltip" title="Sembunyikan Legenda" style="margin-right: 5px; color:white; background-color: #26a69a; "><i class="fa fa-eye-slash style="margin-right: 5px; color:white; background-color: #26a69a;"></i></a> ');
          ...
          var layer = new google.maps.FusionTablesLayer(
            ...
            var legend = document.createElement('div');
                legend.id = 'legend';
                var content = [];
                content.push('<h4 style="text-align: center"><b>Legend</b></h4>');
                ...
                content.push('<p><div class="color h"></div>District of Padang Barat</p>');
                ...
                content.push('<p><div class="color k"></div>District of Koto Tangah</p>');  
        ...
        function hideLegenda() 
        {
          ...
          $('#tombol').empty();
          console.log("Sukses");
          $('#tombol').append('<a type="button" id="showlegenda" onclick="legenda()" class="btn btn-default " data-toggle="tooltip" title="Legenda" style="margin-right: 5px; background-color:#26a69a; color:white;"><i class="fa fa-eye" style="color:white; background-color:#26a69a; "> </i></a>');
        }
...
*********************************************************************************************************************************************************** */
        ...
        {  // HAPUS SEMUA DATA - REBUILD GOOGLE MAP
          //set posisi
          init();
        ...
        function hapus_landmark()
        { // HAPUS MARKER & INFO LANDMARK
...
*********************************************************************************************************************************************************** */
      ...
      function menu_angkot() 
      { // KLIK MENU ANGKOT KIRI
...
*********************************************************************************************************************************************************** */   
      ...
      function data_tourism_1_info(ids) //DETAIL TOURISM GALLERY
      { 
        hapus_kecuali_landmark();
        //init();
        hapus_landmark();
        ...
        $.ajax({url: server+'_data_tourism_1.php?cari='+ids, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows.data){ 
            ...
            marker.info = new google.maps.InfoWindow({
                content: "<span style=color:black><center><b>"+name+"</b></center><br><i class='fa fa-map-marker'></i>"+address+"<br><i class='fa fa-money'></i>"+ticket+"<br><br><a class='btn btn-default fa fa-road' style='color: white; background-color: #26a69a; ' role='button' onclick='route_sekitar(\""+pos_lat+"\",\""+pos_lng+"\",\""+rad_lat+"\",\""+rad_lng+"\")' title='route' aria-controls='Route' id='btn_angkot'></a>&nbsp<a class='btn btn-default fa fa-info' style='color: white; background-color: #26a69a; role=button' onclick='galeri(\""+ids+"\")' title='Info' aria-controls='Info' id='btn_gallery'></a></label>&nbsp<a class='btn btn-default fa fa-compass' style='color: white; background-color: #26a69a; role=button' onclick='cekNearBy()' title='Nearby' aria-controls='Nearby' id='btn_angkot'></a></span>",
                pixelOffset: new google.maps.Size(0, -1)
                  });
            marker.info.open(map, marker);
      ...
      function tampilrute(id, warna, latitude, longitude)
      { //TAMPILKAN RUTE
        ja = new google.maps.Data();
      ...
      *********************************************************************************************************************************************************** */      
      ...
      // UNTUK SIDEBAR MENU DASHBOARD
        ...
        function gallery2(){
          ...
          $('#maps1').show();
          $('#view_kanan_table').hide();
          document.getElementById('judul_table').innerHTML="Recommendation";
...
***********************************************************************************************************************************************************
***********************************************************************************************************************************************************
MENU 1 MENAMPILKAN LIST TOURISM
***********************************************************************************************************************************************************
***********************************************************************************************************************************************************
***********************************************************************************************************************************************************
*********************************************************************************************************************************************************** */
...
***********************************************************************************************************************************************************
***********************************************************************************************************************************************************
MENU 2 PENCARIAN TOURISM DISEKITAR USER
***********************************************************************************************************************************************************
***********************************************************************************************************************************************************
***********************************************************************************************************************************************************
*********************************************************************************************************************************************************** */
...
***********************************************************************************************************************************************************
***********************************************************************************************************************************************************
MENU PENCARIAN BERDASARKAN NAMA, ALAMAT, TIPE, FASILITAS, RATING< HAVE OBJEK WISATA
***********************************************************************************************************************************************************
***********************************************************************************************************************************************************
***********************************************************************************************************************************************************
*********************************************************************************************************************************************************** */
      ...
      function btncarirate(){
        ...
        if(ratecari.value==''){
          ...
          $.ajax({ 
          url: server+'_carirate.php?rate='+ratecari.value, data: "", dataType: 'json', success: function (rows)
          {
            loaddata(rows);
          }
        });
      ...
      //*********************************************************************************
      //FUNGSI PENCARIAN OBJEK WISATA YANG MEMILIKI MESJID DAN RESTAURANT DIDALAM AREANYA
      //*********************************************************************************

      function tourismHave(){ // Menu Tourism
          //clearangkot();
          hapus_menu();
          $('#maps1').show();
          $('#galleryrecommend').hide();
          ...
          $('#kanan_table').append("<tr><th class='centered'>Name</th><th class='centered'colspan='3'>Action</th></tr>");
          $.ajax({ 
          url: server+'_tourism_have.php', data: "", dataType: 'json', success: function(rows) 
          { 
              for (var i in rows){ 
                var row = rows[i];
                var id = row.id;
