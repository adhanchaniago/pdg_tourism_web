...
<div class="col-sm-6"> <!-- menampilkan form add mosque-->
  <section class="panel">
    <div class="panel-body">
      <!-- <a class="btn btn-compose" style="background-color: #26a69a">Update Information</a> -->
      <h2 style="background-color: white; color: #26a69a; font-family: arial; text-align: center;"><i class="fa fa-bars"></i> <b>Update Information</b></h2>
      <br>
      <div class="box-body">
