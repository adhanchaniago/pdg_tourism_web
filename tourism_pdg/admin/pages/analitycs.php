...
<div class="col-sm-12">  <!-- menampilkan list mosque-->
    <section class="panel">
        <div class="panel-body">
            ...
            <h2 style="background-color: white; color: #26a69a; font-family: arial"><i class="fa fa-bar-chart"></i><b> Website Analitycs</b></h2>
            <br>
...
<!-- <a href="?page=" title="Add Tourism" style="color: white" class="act-btn">
    +
</a> -->