              ...
              <div class="col-sm-6"> 
                ...
                <section class="panel">
                  ...
                  <?php 
                      ...
                      $sql = "SELECT * FROM worship_place WHERE id = '$id'";
                  ...
                  <div class="panel-body">
                    <table class="table">
                      <thead></thead>
                        ...
                        {
                          $id_mesjid = $rows['id'];
                          $name_mesjid = $rows['name'];
                          $address_mesjid = $rows['address'];
                          $capacity = $rows['capacity'];
                          $est = $rows['est'];
                          $teenager = $rows['teenager'];
                          $parking = $rows['park_area_size'];
                          $category = $rows['id_category'];
                          ?>
                        <tbody> 
                          <tr>
                            <td>Name</td><td>:</td><td><?php echo $name_mesjid; ?></td>  
                          </tr>
                          <tr>
                            <td>Address</td><td>:</td><td><?php echo $address_mesjid; ?></td>
                          </tr>
                          <tr>
                            <td>Capacity</td><td>:</td><td><?php echo $capacity.' '.'Jamaah'?></td>
                          </tr>
                          <tr>
                            <td>Since</td><td>:</td><td><?php echo $est; ?></td>
                          </tr>
                          <tr>
                            <td>Teenager</td><td>:</td><td><?php echo $teenager; ?></td>
                          </tr>
                          <tr>
                            <td>Parking Area</td><td>:</td><td><?php echo $parking.' '.'m2' ?></td>
                          </tr>
                          <tr>
                ...
                <section class="panel">
                  <header class="panel-heading">
                    <h2 class="box-title" style="text-transform:capitalize; text-align: center"><b> Event</b></h2>
                  </header>
                    <?php 
                      require '../connect.php';
                      $id = $_GET["idgallery"];
                                        
                      $sql = "SELECT * FROM detail_event WHERE id_worship_place = '$id'";
                      $result = mysqli_query($conn, $sql);
                    ?>
