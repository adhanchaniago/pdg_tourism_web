          ...
          <div class="col-lg-12 main-chart"> 
            <div class="col-sm-12">
              <div class="col-sm-6"> 
                    ...
                    <table class="table">
                      <thead></thead>
                        ...
                        while ($rows = mysqli_fetch_array($result)) 
                        {
                          $id_sou = $rows['id'];
                          $name_sou = $rows['name'];
                          $address_sou = $rows['address'];
                          $status = $rows['status'];
                          $type_sou = $rows['type_name'];
                          $owner = $rows['owner'];
                          $cp_sou = $rows['cp'];
                          $category = $rows['id_category'];
                          ?>
                        <tbody> 
                          <tr>
                            <td>Name</td><td>:</td><td><?php echo $name_sou; ?></td>  
                          </tr>
                          <tr>
                            <td>Address</td><td>:</td><td><?php echo $address_sou; ?></td>
                          </tr>
                          <tr>
                            <td>Status</td><td>:</td><td><?php echo $status ?></td>
                          </tr>
                          <tr>
                            <td>Type</td><td>:</td><td><?php echo $type_sou ?></td>
                          </tr>
                          <tr>
                            <td>Owner</td><td>:</td><td><?php echo $owner; ?></td>
                          </tr>
                          <tr>
                            <td>Contact Person</td><td>:</td><td><?php echo $cp_sou ?></td>
                          </tr>
                        </tbody>
                ...
                <section class="panel">
                  <header class="panel-heading">
                    <h2 class="box-title" style="text-transform:capitalize; text-align: center"><b> Product</b></h2>
                  </header>
                    <?php 
                      require '../connect.php';
                      $id = $_GET["idgallery"];
                ...
                <section class="panel">
                  <header class="panel-heading">
                    ...
                    <?php 
                      ...
                      $sql = "SELECT * FROM detail_facility_souvenir
                              LEFT JOIN facility_souvenir ON detail_facility_souvenir.facility_id = facility_souvenir.id
