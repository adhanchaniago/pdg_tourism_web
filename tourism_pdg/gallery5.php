          ...
          <div class="col-lg-12 main-chart"> 
            <div class="col-sm-12">
              <div class="col-sm-6"> 
                  ...
                  <div class="panel-body">
                    <table class="table">
                      <thead></thead>
                        ...
                        <tbody> 
                          <tr>
                            <td>Name</td><td>:</td><td><?php echo $name_res; ?></td>  
                          </tr>
                          <tr>
                            <td>Address</td><td>:</td><td><?php echo $address_res; ?></td>
                          </tr>
                          <tr>
                            <td>Open</td><td>:</td><td><?php echo $open ?></td>
                          </tr>
                          <tr>
                            <td>Close</td><td>:</td><td><?php echo $close ?></td>
                          </tr>
                          <tr>
                            <td>Type</td><td>:</td><td><?php echo $type_res; ?></td>
                          </tr>
                ...
                <section class="panel">
                  <header class="panel-heading">
                    <h2 class="box-title" style="text-transform:capitalize; text-align: center"><b> Culinary</b></h2>
                  </header>
                    <?php 
                      require '../connect.php';
                      $id = $_GET["idgallery"];
                                        
                      $sql = "SELECT * FROM detail_product_souvenir
                              LEFT JOIN product_souvenir ON detail_product_souvenir.id_product = product_souvenir.id
                ...
                <section class="panel">
                  <header class="panel-heading">
                    ...
                    <?php 
                      ...
                      $sql = "SELECT * FROM detail_facility_restaurant
                              LEFT JOIN facility_restaurant ON detail_facility_restaurant.id_facility = facility_restaurant.id
                      ...
                      <?php 
                        ...
                        if(strpos($id,"H") !== false){
                          ...
                          $sqlreview = "SELECT * from information_admin where id_souvenir = '$id'";
                           ...
                           $sqlreview = "SELECT * from information_admin where id_restaurant = '$id'";
                        }
                        // echo $sqlreview;
